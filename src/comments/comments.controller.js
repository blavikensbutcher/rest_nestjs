...
var CommentsController = function () {
    var _classDecorators = [(0, common_1.Controller)('comments'), (0, swagger_1.ApiTags)('Comment')];
    ...
    var CommentsController = _classThis = /** @class */ (function () {
        ...
        CommentsController_1.prototype.create = function (createCommentDto) {
            return this.commentsService.create(createCommentDto);
        };
        CommentsController_1.prototype.findAll = function () {
            return this.commentsService.findAll();
        };
        CommentsController_1.prototype.findOne = function (id) {
            return this.commentsService.findOne(id);
        };
        CommentsController_1.prototype.update = function (id, updateCommentDto) {
            return this.commentsService.update(id, updateCommentDto);
        };
        CommentsController_1.prototype.remove = function (id) {
